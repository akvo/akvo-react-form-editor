  ...
  const output = questionGroups.map(qg => {
    const questions = qg.questions.map(q => {
      ...
      if ([questionType.option, questionType.multiple_option].includes(q.type)) {
        ...
        const options = (((_q6 = q) === null || _q6 === void 0 ? void 0 : _q6.options) || []).map(op => {
...
const SettingGeo = ({
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("p", {
    ...
    type: "warning"
  }, UIText.inputGeoDetectOverlapsHint)), detectOverlaps && /*#__PURE__*/React__default.createElement(Row, {
    align: "middle",
    gutter: [24, 24]
  }, /*#__PURE__*/React__default.createElement(Col, {
    span: 8
